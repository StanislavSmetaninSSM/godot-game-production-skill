...
6. Only when the emitted immutable `visual-generation-authorization/v1` says `AUTHORIZED`, invoke ImageGen. Make at most one call for every authorized slot and no call for any other slot.
